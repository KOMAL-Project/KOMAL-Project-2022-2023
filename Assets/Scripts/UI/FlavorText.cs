...
public class FlavorText : MonoBehaviour
{
    public static Dictionary<string, string> flavorText = new Dictionary<string, string>
    {
        ...
        {"1-11", "Boxes of Fun" },
        {"1-12", "Finale - Overriding Charges" },
